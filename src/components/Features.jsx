...
const features = [
  ...
  },
  {
    ...
    title: "Locally Owned",
    description: "Join Okilau Rewards to earn gift cards and enjoy exclusive member benefits.",
  },
  {
    id: 3,
    image: assets.feature_icon_03,
    title: "Money Back Guarantee",
    description: "We believe getting dressed should be the easiest part of your day.",
  },
];

const Features = () => {
  return (
    <section className="px-4 py-16 md:px-8 lg:px-24">
      ...
      <h2 className="mb-16 text-center font-['Anton'] text-2xl uppercase leading-tight tracking-wide text-black sm:text-3xl lg:mx-auto lg:max-w-3xl lg:text-4xl">
        Product Artwork Is Created By Talented <br />
